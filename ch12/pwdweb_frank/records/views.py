...
class EncryptionMixin:
    def form_valid(self, form): #override the form valid method
        self.encrypt_password(form)
        return super(EncryptionMixin, self).form_valid(form)

    def encrypt_password(self, form):
        self.object = form.save(commit=False) #creates Record instance
...
class RecordUpdateView(
    ...
    def form_valid(self, form):
        # URL redirection하는 부분
        self.success_url = reverse_lazy( #todo: 잘 이해가 안됨
            'records:edit',
    ...
    def get_form_kwargs(self):
        ...
        kwargs['instance'].decrypt_password() #Record instance에 접근해서 decrypt를 함
        return kwargs
