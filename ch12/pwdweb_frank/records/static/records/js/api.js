...
var getRandomPassword = function () {
    ...
    $.ajax({
        ...
        success: function (data, status, request) {
            console.log("[getRandomPassword] data: " + JSON.stringify(data) + " status: " + status + " request: " + JSON.stringify(request));
...
$(function () {
    $('#generate-btn').click(getRandomPassword); //함수를 bind 시킴
});
...
var validatePassword = function () {
    ...
    $.ajax({
        ...
        success: function (data, status, request) {
            console.log("[validatePassword] data: " + JSON.stringify(data) + " status: " + status + " request: " + JSON.stringify(request));
